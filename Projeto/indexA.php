        ...
        <table class="striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="editar_artista.php?id=<?php echo $dados[0]; ?>" class="btn-floating orange"><i class="material-icons">edit</i>
              </a></td>
              <td><a href="#modal<?php echo $dados[0]; ?>" class="btn-floating red modal-trigger"><i class="material-icons">delete</i>
              </a></td>
              <!-- Modal Structure -->
