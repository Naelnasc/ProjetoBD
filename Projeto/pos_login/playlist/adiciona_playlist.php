<html>
    ...
    <div class="row">
      <div class="col s12 m6 push-m3">
        ...
        <form action="crud/cria_playlist.php" method="POST">

            <div class="input-field col s12">
            <input type="text" name="nome" id="nome" required name="nome">
          ...
          <div class="input-field col s12">
            <input type="text" title="Ativo/Inativo" name="status" id="status" required name="status">
          ...
          <a href="indexP.php" class="btn green">Lista das Playlists</a>
        </form>
      </div>
    </div>
