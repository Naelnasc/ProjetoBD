...
<html lang="pt-br" dir = "ltr">
  ...
  <body>      
    ...
    <?php
        if(isset($_SESSION['mensagemP'])):?>
        <script>
          //mensagem de alerta
          window.onload = function(){
            M.toast({html: '<?php echo $_SESSION['mensagemP'];?>'})
          };
        </script>
      <?php  
        endif;
        ...
        unset($_SESSION['mensagemP']);
      ?>
        
    <div class="row">
      <div class="col s12 m6 push-m3">
        <h3 class="light">Playlist</h3>
        <table class="striped">
          <thead>
            <tr>
              <th>Nome:</th>
          ...
          <tbody>
            <?php
              ...
              $sql = "SELECT nome,email,data_da_criacao,status FROM deezefy.playlist;";
            ...
            <tr>
              ...
              <td><?php echo $dados['data_da_criacao'];?></td>
              <td><?php echo $dados['status'];?></td>
              <td><a href="editar_playlist.php?id=<?php echo $dados[0]; ?>" title="Editar" class="btn-floating orange"><i class="material-icons">edit</i>
              </a></td>
              ...
              <!-- Modal Structure -->
                <div id="modal<?php echo $dados[0]; ?>" class="modal">
                  <div class="modal-content">
                    <h4>Opa!</h4>
                      <p>Tem certeza que deseja excluir essa playlist?</p>
                  </div>
                  <div class="modal-footer">
                  <form action="crud/deleta_playlist.php" method="POST">
        ...
        <br>
        <a href="adiciona_playlist.php" class="btn">Adiconar Playlist</a>
      </div>
    </div>
              <script>
                M.AutoInit();
